...
class UserServiceTest {
    ...
    void setUp() {
        ...
        testUser.setEmail("test@healthysleep.com");
        
        testUser2 = new User();
        testUser2.setId(2L);
        testUser2.setUsername("testUser2");
        testUser2.setEmail("test2@healthysleep.com");
    ...
    void createUser_ShouldSaveAndCacheUser() {
        // Arrange
        when(userRepository.existsByEmail("test@healthysleep.com")).thenReturn(false);
    ...
    void createUser_ShouldThrowDuplicateEmailExceptionWhenEmailExists() {
        // Arrange
        when(userRepository.existsByEmail("test@healthysleep.com")).thenReturn(true);
    ...
    void updateUser_ShouldUpdateEmailWhenNotDuplicate() {
        // Arrange
        User updatedUser = new User();
        updatedUser.setEmail("new@healthysleep.com");
        
        when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
        when(userRepository.existsByEmail("new@healthysleep.com")).thenReturn(false);
        when(userRepository.save(testUser)).thenReturn(testUser);
        ...
        // Assert
        assertEquals("new@healthysleep.com", result.getEmail());
    }
    ...
    void updateUser_ShouldThrowDuplicateEmailExceptionWhenEmailExists() {
        // Arrange
        User updatedUser = new User();
        updatedUser.setEmail("existing@healthysleep.com");
        
        when(userRepository.findById(1L)).thenReturn(Optional.of(testUser));
        when(userRepository.existsByEmail("existing@healthysleep.com")).thenReturn(true);
    ...
    void updateEmail_ShouldNotUpdateWhenEmailIsNull() {
        ...
        // Assert
        assertEquals("test@healthysleep.com", testUser.getEmail());
    }
